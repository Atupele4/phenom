 ...
 public function get_ledger($slug)
      ...
      public function search($search)
    {
     if($search == null) 
     {
        ...
        {
            $query = $this->db->query("SELECT * FROM client_details INNER JOIN case_summary ON case_summary.c_s_c_id = client_details.c_id WHERE client_details.c_name LIKE ('%$search%') OR case_summary.c_s_file_number LIKE ('%$search%') OR case_summary.c_s_desc LIKE ('%$search%') ");                             return $query->result_array();
        }
    }
